...
const navLinks = [
  ...
  {
    label: 'Docs',
    href: 'https://docs.larasonic.com/introduction',
    external: true,
  },
]
  ...
  <div class="min-h-screen">
    ...
    >
      ...
      >
        <div class="flex items-center">
          ...
          <nav
            class="hidden md:flex items-center space-x-6 text-sm font-medium sm:ml-4"
          >
            <a
        ...
        <div class="flex items-center space-x-4">
          ...
          >
            <Icon
              ...
              :icon="
                mode === 'dark' ? 'lucide:sun' : 'lucide:moon'
              "
            />
          </Button>
          <a
    ...
    <footer class="border-t">
      <div class="container mx-auto px-4 py-8 sm:px-6 lg:px-8">
        ...
        >
          <p
            class="text-sm flex items-center gap-2 text-center sm:text-left"
          >
            <Icon
              icon="lucide:rocket"
              class="size-6"
