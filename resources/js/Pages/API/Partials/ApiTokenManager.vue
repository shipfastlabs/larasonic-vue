    ...
    <div>
        ...
        <FormSection @submitted="createApiToken">
            ...
            <template #form>
                ...
                <div class="col-span-6 sm:col-span-4">
                    ...
                    <Input id="name" v-model="createApiTokenForm.name" type="text" class="mt-1 block w-full"
                        autofocus />
        ...
        <DialogModal :show="managingPermissionsFor != null" @close="managingPermissionsFor = null">
            ...
            <template #footer>
                ...
                <Button class="ms-3" :class="{ 'opacity-25': updateApiTokenForm.processing }"
        ...
        <ConfirmationModal :show="apiTokenBeingDeleted != null" @close="apiTokenBeingDeleted = null">
            ...
            <template #footer>
                ...
                <Button variant="destructive" class="ms-3" :class="{ 'opacity-25': deleteApiTokenForm.processing }"
