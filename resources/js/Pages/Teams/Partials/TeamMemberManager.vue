    ...
    <div>
        ...
        <DialogModal :show="currentlyManagingRole" @close="currentlyManagingRole = false">
            ...
            <template #footer>
                ...
                <Button class="ms-3" :class="{ 'opacity-25': updateRoleForm.processing }"
        ...
        <ConfirmationModal :show="confirmingLeavingTeam" @close="confirmingLeavingTeam = false">
            ...
            <template #footer>
                ...
                <Button variant="destructive" class="ms-3" :class="{ 'opacity-25': leaveTeamForm.processing }"
        ...
        <ConfirmationModal :show="teamMemberBeingRemoved" @close="teamMemberBeingRemoved = null">
            ...
            <template #footer>
                ...
                <Button variant="destructive" class="ms-3" :class="{ 'opacity-25': removeTeamMemberForm.processing }"
