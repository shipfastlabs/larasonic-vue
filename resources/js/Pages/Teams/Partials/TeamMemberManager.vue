...
<template>
  <div>
          ...
          >
            ...
            >
              <button
                ...
                :class="{
                  'rounded-t-none border-t focus:border-none ':
                    i > 0,
                  'rounded-b-none':
                    i
    ...
    <Dialog
      ...
      @update:open="currentlyManagingRole = false"
    >
      <DialogContent>
        <DialogHeader>
        ...
        <div v-if="managingRoleFor">
          <div
            class="relative z-0 mt-1 cursor-pointer rounded-lg border border-primary"
          >
            <button
              v-for="(role, i) in availableRoles"
              :key="role.key"
    ...
    <Dialog
      ...
      @update:open="confirmingLeavingTeam = false"
    >
      <DialogContent>
        <DialogHeader>
    ...
    <Dialog
      ...
      @update:open="teamMemberBeingRemoved = null"
    >
      <DialogContent>
        <DialogHeader>
